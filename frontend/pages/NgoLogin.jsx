...
const App = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#1a1f2e] flex items-center justify-center p-4">
      <div className="w-full max-w-[480px] bg-[#252b3b]/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#2f364a] text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
